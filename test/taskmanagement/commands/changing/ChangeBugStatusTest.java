...
class ChangeBugStatusTest {
    ...
    void setUp() {
        ...
        this.command = new ChangeBugStatus(taskManagementRepository);
    }
    ...
    void should_ChangeBugPriority_When_ArgumentsAreValid() {
        List<String> params = List.of(String.valueOf(1), String.valueOf(BugStatus.DONE));
